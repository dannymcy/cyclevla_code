...
# CUDA_VISIBLE_DEVICES="3" python experiments/robot/libero/run_libero_eval_decomposed_progress_mbr.py   --pretrained_checkpoint /hdd2/kai/openvla-oft/checkpoints/libero/libero_sub_decomposed_progress_A100/openvla-7b+libero_decomposed_progress+b16+lr-0.0005+lora-r32+dropout-0.0--image_aug--parallel_dec--8_acts_chunk--continuous_acts--diffusion--3rd_person_img--wrist_img--proprio_state--50000_chkpt   --task_suite_name libero_spatial
# CUDA_VISIBLE_DEVICES="3" python experiments/robot/libero/run_libero_eval_decomposed_progress_mbr.py   --pretrained_checkpoint /hdd2/kai/openvla-oft/checkpoints/libero/libero_sub_decomposed_progress_A100/openvla-7b+libero_decomposed_progress+b16+lr-0.0005+lora-r32+dropout-0.0--image_aug--parallel_dec--8_acts_chunk--continuous_acts--diffusion--3rd_person_img--wrist_img--proprio_state--50000_chkpt   --task_suite_name libero_object
# CUDA_VISIBLE_DEVICES="3" python experiments/robot/libero/run_libero_eval_decomposed_progress_mbr.py   --pretrained_checkpoint /hdd2/kai/openvla-oft/checkpoints/libero/libero_sub_decomposed_progress_A100/openvla-7b+libero_decomposed_progress+b16+lr-0.0005+lora-r32+dropout-0.0--image_aug--parallel_dec--8_acts_chunk--continuous_acts--diffusion--3rd_person_img--wrist_img--proprio_state--50000_chkpt   --task_suite_name libero_goal
# CUDA_VISIBLE_DEVICES="3" python experiments/robot/libero/run_libero_eval_decomposed_progress_mbr.py   --pretrained_checkpoint /hdd2/kai/openvla-oft/checkpoints/libero/libero_sub_decomposed_progress_A100/openvla-7b+libero_decomposed_progress+b16+lr-0.0005+lora-r32+dropout-0.0--image_aug--parallel_dec--8_acts_chunk--continuous_acts--diffusion--3rd_person_img--wrist_img--proprio_state--50000_chkpt   --task_suite_name libero_10
